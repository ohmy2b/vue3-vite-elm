    ...
    export default {
      ...
      setup(){
            ...
            const state=reactive({
                ...
                timer:null,
                orderMessage:store.state.orderMessage,
                userInfo:store.state.userInfo,
                shopid:store.state.shopid,
                cartPrice:store.state.cartPrice
            })
        ...
        onMounted(()=>{remainingTime()})
        beforeUnmounted(()=>{clearInterval(state.timer);})
        remaining=computed(()=>{
            ...
            const initData=async()=>{
            	state.payDetail = await payRequest(store.state.orderMessage.order_id, store.state.userInfo.user_id);
            ...
            return {...toRefs(state),closeTipFun,confrimPay,initData,remainingTime,remaining}
        // computed: {
        //     ...mapState([
