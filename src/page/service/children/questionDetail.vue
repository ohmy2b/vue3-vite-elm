...
<script>
    ...
    export default {
      ...
      setup(){
            ...
            const state=reactive({userInfo:store.state.userInfo})
            onMounted(()=>{
                this.$nextTick(() => {
            ...
            markdownText=computed(()=>{
                let converter = new showdown.Converter();  
	            return converter.makeHtml(state.question.detail);  
            })
            return{...toRefs(state).markdownText}
        },
